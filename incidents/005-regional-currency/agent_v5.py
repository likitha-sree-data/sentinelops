...
Investigate thoroughly. List every distinct issue you find, not just the first one, each with a confidence score (0 to 1) and reasoning tied to specific evidence above. Do not stop after finding one explanation if the evidence supports more than one."""
